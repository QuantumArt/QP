...
| qp_mass_update_content_item | Массовое создание или обновление записей в [таблице CONTENT_ITEM](main#таблица-content_item). Реализована только в PG (в SQL Server испольузется ad-hoc запрос) |
