...
| qp_content_change_column_types | Изменение типов полей [контентных таблиц](customer#контентные-таблицы) в сооответствии со значением поля USE_NATIVE_EF_TYPES [таблицы CONTENT](access#таблица-content). Включает в себя пересборку представлений. Используется только в PostgreSQL |
| qp_content_change_column_types_forced | Изменение типов полей [контентных таблиц](customer#контентные-таблицы) в сооответствии с явно переданным значением параметра использования нативных типов EF. Включает в себя пересборку представлений. Используется только в PostgreSQL |
...
| qp_content_table_change_column_types | Изменение типов полей [конкретной контентной таблицы](customer#контентные-таблицы) в сооответствии с явно переданным значением параметра использования нативных типов EF. Используется только в PostgreSQL |
