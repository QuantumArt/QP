...
| LAST_MODIFIED_BY | ID последнего пользователя ([Таблица USERS](access#таблица-users)), менявшего сниппет |
| SITE_ID | |
...
| CONTENT_ID | ID контента, для которого создается контейнер ([Таблица CONTENT](main#таблица-content)) |
...
| LOCKED_BY | ID пользователя ([Таблица USERS](access#таблица-users)), заблокировавшего свойства PublishingContainer (NULL, если свойства не заблокированы) |
...
|----------------|----------|
| OBJECT_ID | ID объекта ([Таблица OBJECT](#таблица-object)) |
| STATUS_TYPE_ID | Идентификатор статуса ([Таблица STATUS_TYPE](main#таблица-status_type)) |
...
| PAGE_ID | ID страница ([Таблица PAGE](other#таблица-PAGE)) |
...
| LAST_MODIFIED_BY | ID последнего пользователя ([Таблица USERS](access#таблица-users)), менявшего объект |
...
| LOCKED_BY | ID пользователя ([Таблица USERS](access#таблица-users)), заблокировавшего объект (NULL, если объект не заблокированы) |
...
| LAST_MODIFIED_BY | ID последнего пользователя ([Таблица USERS](access#таблица-users)), менявшего формат |
| FORMAT_BODY | Содержание формата (Presentation) |
| NET_LANGUAGE_ID | .NET-языкформата ([Таблица NET_LANGUAGES](other#таблица-net-languages)) |
...
| LOCKED_BY | ID пользователя ([Таблица USERS](access#таблица-users)), заблокировавшего формат (NULL, если формат не заблокирован) |
...
| LAST_MODIFIED_BY | ID последнего пользователя ([Таблица USERS](access#таблица-users)), менявшего страницу |
| ASSEMBLED | Дата последней пересборки страницы |
| LAST_ASSEMBLED_BY | ID последнего пользователя ([Таблица USERS](access#таблица-users)), собиравшего страницу |
...
| LOCKED_BY | ID пользователя ([Таблица USERS](access#таблица-users)), заблокировавшего страницу (NULL, если страница не заблокирована) |
| ENABLE_VIEWSTATE | Поддерживает ли собираемый для объекта контрол ViewState? |
...
| LAST_MODIFIED_BY | ID последнего пользователя ([Таблица USERS](access#таблица-users)), менявшего шаблон |
| CHARSET | Набор символов |
| CODEPAGE | Кодовая страница |
| LOCALE | Локаль |
...
| LOCKED_BY | ID пользователя ([Таблица USERS](access#таблица-users)), заблокировавшего шаблон (NULL, если шаблон не заблокирован) |
...
| LAST_MODIFIED_BY | ID последнего пользователя ([Таблица USERS](main#таблица-users)), менявшего стиль |
| SITE_ID | ID родительского сайта ([Таблица SITE](main#таблица-site)) |
