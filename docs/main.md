...
| ti_content_data_fill | Выполняется после вставки записей. Обновляет содержимое [контентной таблицы](customer#контентные-таблицы-content_nnn) и [асинхронной контентной таблицы](customer#асинхронные-контентные-таблицы-content_nnn_async). Реализован только в PG |
| tu_content_data_fill | Выполняется после обновления записей. Обновляет содержимое [контентной таблицы](customer#контентные-таблицы-content_nnn) и [асинхронной контентной таблицы](customer#асинхронные-контентные-таблицы-content_nnn_async). Реализован только в PG. |
...
| tu_item_to_item | Выполняется после обновления записи в таблице. Обновляет запись в [связующей таблице](customer#связующие-таблицы-item_link_nn) и [обратной связующей таблице](customer#обратные-связующие-таблицы-item_link_nn_rev). Не реализован в PG, в SQL Server используется только в клонировании сайта. |
