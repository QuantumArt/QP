...
Хранит содержимое всех пользовательских таблиц ([Пользовательские таблицы CONTENT_NNN](customer#пользовательские-таблицы-content_nnn)). Каждая строка в данной таблице соответствует ячейке в пользовательской таблице и копируется туда триггером или одной из хранимых процедур массового копирования.
