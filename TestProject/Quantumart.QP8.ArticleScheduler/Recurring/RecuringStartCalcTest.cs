...
namespace WebMvc.Test.Quantumart.QP8.ArticleScheduler.Recurring
{
	[TestClass]
	public class RecuringStartCalcTest
	{
		...
		{
			IRecuringStartCalc startCalculator = new MonthlyRelativeStartCalc(9, 4, 5,
				new DateTime(2011, 1, 5), new DateTime(2011, 12, 31),
				new TimeSpan(12, 15, 17));
		...
		public void MonthlyStartCalcTest()
		{
			...
			IRecuringStartCalc startCalculator = new MonthlyStartCalc(15, 3,
				new DateTime(2011, 3, 16), new DateTime(2011, 11, 24),
				new TimeSpan(12, 15, 17));
		...
		{			
			...
			IRecuringStartCalc startCalculator = new WeeklyStartCalc(42, 3,
				new DateTime(2011, 6, 1), new DateTime(2011, 7, 12),
				new TimeSpan(12, 15, 17));
		...
		public void DailyStartCalcTest()
		{
			...
			IRecuringStartCalc startCalculator = new DailyStartCalc(4,
				new DateTime(2011, 6, 1), new DateTime(2011, 6, 10),
				new TimeSpan(12, 15, 17));
