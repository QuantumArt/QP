...
namespace Quantumart.QP8.ArticleScheduler.Recurring
{
	...
	public class RecurringTask
	{
		...
		public RecurringTask(int id, int articleId, RecurringTaskTypes taskType, int interval, int relativeInterval, int recurrenceFactor,
			DateTime startDate, DateTime endDate, TimeSpan startTime, TimeSpan duration)
		{
			Id = id;
			ArticleId = articleId;
			TaskType = taskType;
