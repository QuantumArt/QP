...
namespace Quantumart.QP8.BLL
{
    ...
    public abstract class EntityObject : BizObject
    {
		...
		#region simple read-write
			...
			[FormatValidator(Constants.RegularExpressions.InvalidEntityName, Negated = true, MessageTemplateResourceName = "NameInvalidFormat", MessageTemplateResourceType = typeof(EntityObjectStrings))]
		...
		#region simple read-only
			...
			/// </summary>
			public virtual string EntityTypeCode
			{
				get
				{
					return Constants.EntityTypeCode.None;
				}
			}
			...
			/// </summary>
			public virtual int? RecurringId
			{
				get
				{
					return null;
			...
			public bool IsUpdatable
			{
				get
				{
					return IsAccessible(ActionTypeCode.Update);
				}
			}

			public virtual string CannotAddBecauseOfSecurityMessage
			{
				get
				{
					return EntityObjectStrings.CannotAddBecauseOfSecurity;
				}
			}

			public virtual string CannotUpdateBecauseOfSecurityMessage
			{
				get
				{
					return EntityObjectStrings.CannotUpdateBecauseOfSecurity;
				}
			}

			public virtual string PropertyIsNotUniqueMessage
			{
				get
				{
					return EntityObjectStrings.NameNonUnique;
				}
			}

			public virtual string UniquePropertyName { get { return "Name"; } }
		...
		/// </summary>		
		public virtual PathInfo PathInfo
		{
			get
			{
				return new PathInfo { Path = String.Empty, Url = String.Empty };
			}
		}
		...
		public virtual EntityObject Parent
		{
			get
			{
				return null;
		...
		{
			EntityObject.EntLibValidate(errors, this);
		...
		public static void VerifyIdentityInserting(string entityTypeCode, int id, int forceId)
		{
			...
			{
			if (id == 0 && forceId == 0)
				throw new InvalidOperationException(String.Format("Attempt to insert entity (key = '{0}', ID = 0)", entityTypeCode));
			}
		}
