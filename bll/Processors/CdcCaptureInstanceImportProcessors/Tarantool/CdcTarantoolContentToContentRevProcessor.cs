...
{
    public sealed class CdcTarantoolContentToContentRevProcessor : BaseCdcTarantoolImportProcessor
    {
        public CdcTarantoolContentToContentRevProcessor(string captureInstanseName)
                    ...
                    return new CdcTableTypeModel
                    {
                        ...
                        Entity = new CdcEntityModel
                        {
                            ...
                            Columns = new Dictionary<string, object>
                            {
                                ...
                                { TarantoolContentToContentModel.InvariantName, TarantoolContentToContentModel.GetInvariantName(linkId, true) },
