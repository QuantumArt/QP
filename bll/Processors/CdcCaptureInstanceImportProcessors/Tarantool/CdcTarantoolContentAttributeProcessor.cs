...
{
    public sealed class CdcTarantoolContentAttributeProcessor : BaseCdcTarantoolImportProcessor
    {
        public CdcTarantoolContentAttributeProcessor(string captureInstanseName)
                    ...
                    return new CdcTableTypeModel
                    {
                        ...
                        Entity = new CdcEntityModel
                        {
                            ...
                            Columns = new Dictionary<string, object>
                            {
                                ...
                                { TarantoolContentAttributeModel.ContentInvariantName, TarantoolContentAttributeModel.GetContentInvariantName(contentId, false) },
