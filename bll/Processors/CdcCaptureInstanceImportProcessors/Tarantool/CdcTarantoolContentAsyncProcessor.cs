...
{
    public sealed class CdcTarantoolContentAsyncProcessor : BaseCdcTarantoolImportProcessor
    {
        public CdcTarantoolContentAsyncProcessor(string captureInstanseName)
                    ...
                    return new CdcTableTypeModel
                    {
                        ...
                        Entity = new CdcEntityModel
                        {
                            ...
                            Columns = new Dictionary<string, object>
                            {
                                ...
                                { TarantoolContentModel.InvariantNameSync, TarantoolContentModel.GetInvariantName(contentId, !isAsync) },
