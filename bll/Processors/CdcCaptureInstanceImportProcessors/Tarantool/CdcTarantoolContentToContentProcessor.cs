...
{
    public sealed class CdcTarantoolContentToContentProcessor : BaseCdcTarantoolImportProcessor
    {
        public CdcTarantoolContentToContentProcessor(string captureInstanseName)
                    ...
                    return new CdcTableTypeModel
                    {
                        ...
                        Entity = new CdcEntityModel
                        {
                            ...
                            Columns = new Dictionary<string, object>
                            {
                                ...
                                { TarantoolContentToContentModel.InvariantName, TarantoolContentToContentModel.GetInvariantName(linkId, false) },
