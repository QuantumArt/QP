...
namespace Quantumart.QP8.BLL.Repository
{
    internal class SiteRepository
    {
        ...
        {
            return QPContext.EFContext.SiteSet.Select(n => new PathInfo { Url = (n.UseAbsoluteUploadUrl == 1 ? n.UploadUrlPrefix : "http://" + n.Dns) + n.UploadUrl, Path = n.UploadDir, BaseUploadUrl = (n.UseAbsoluteUploadUrl == 1 ? n.UploadUrlPrefix : "http://" + n.Dns)}).ToList();
        }
