...
namespace Quantumart.QP8.BLL.Repository.ActiveDirectory
{
	internal class ActiveDirectoryRepository
	{
		...
		private readonly string[] _groupProperties = new[] { "cn", "memberOf" };
		private readonly string[] _userProperties = new[] { "cn", "memberOf", "sn", "givenName", "mail", "sAMAccountName", "userAccountControl" };
		...
		private string[] GetGroupReferences(ActiveDirectoryGroup[] membership)
		{
