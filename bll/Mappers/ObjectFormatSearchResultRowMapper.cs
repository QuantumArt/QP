...
{
    internal class ObjectFormatSearchResultRowMapper : GenericMapper<ObjectFormatSearchResultListItem, DataRow>
    {
        public override void CreateBizMapper(IMapperConfigurationExpression cfg)
        {
            cfg.CreateMap<DataRow, ObjectFormatSearchResultListItem>(MemberList.Source)
