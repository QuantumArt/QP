...
{
	class ObjectFormatRowMapper : GenericMapper<ObjectFormatListItem, DataRow>
	{
		...
		private static void SetBizProperties(DataRow dataObject, ObjectFormatListItem bizObject)
		{
			...
			bizObject.LockedByIcon = ObjectFormat.GetLockedByIcon(bizObject.LockedBy);
			bizObject.LockedByToolTip = ObjectFormat.GetLockedByToolTip(bizObject.LockedBy, bizObject.LockedByFullName);
		}
	}
}
