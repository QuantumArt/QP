...
namespace Quantumart.QP8.BLL.Helpers
{
	public class MutateHelper
	{
		...
		public static string MutateString(string value, int mutationStep)
		{
			return String.Format("{0} {1}", value, mutationStep);
		}

		public static string MutateNetName(string value, int mutationStep)
		{
			return String.Format("{0}{1}", value, mutationStep);
		}

		public static string MutateUserLogin(string value, int mutationStep)
		{
			return String.Format("{0}{1}", value, mutationStep);
		}

		public static int MutateInt(int value, int mutationStep)
		{
