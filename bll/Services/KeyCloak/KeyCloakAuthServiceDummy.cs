...
public class KeyCloakAuthServiceDummy : IKeycloakAuthService
{
    private const string Disabled = "KeyCloak disabled in appsettings.json";

    public Task<KeyCloakAuth> CheckUserAuth(string code, string verifier) => throw new NotImplementedException(Disabled);
