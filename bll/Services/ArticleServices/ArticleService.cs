...
namespace Quantumart.QP8.BLL.Services.ArticleServices
{
    public class ArticleService : IArticleService
    {
        ...
        public static ListResult<SimpleDataRow> List(int contentId, int[] selectedArticleIDs, ListCommand cmd, IList<ArticleSearchQueryParam> searchQueryParams, IList<ArticleContextQueryParam> contextQueryParams, Dictionary<string, object[]> filter, ArticleFullTextSearchQueryParser ftsParser, bool? onlyIds = null, int[] filterIds = null)
        {
