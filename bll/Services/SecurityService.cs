...
namespace Quantumart.QP8.BLL.Services
{
    ...
    public class SecurityService : ISecurityService
    {
        ...
        /// </summary>
        public bool IsEntityAccessible(string entityTypeCode, int entityId, string actionTypeCode) => SecurityRepository.IsEntityAccessible(entityTypeCode, entityId, actionTypeCode);

        public bool IsActionAccessible(string actionCode) => SecurityRepository.IsActionAccessible(actionCode);
        ...
        public bool IsCurrentUserAdmin() => QPContext.IsAdmin;
    }
}
