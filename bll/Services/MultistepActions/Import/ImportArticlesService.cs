...
namespace Quantumart.QP8.BLL.Services.MultistepActions.Import
{
    public class ImportArticlesService : MultistepActionServiceAbstract
    {
        ...
        {
            var settings = HttpContext.Current.Session[ImportSettingsSessionKey] as ImportSettings;
        ...
        public static string ImportSettingsSessionKey => "ImportArticlesService.Settings";
    }
}
