...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('article') and code = 'select_child_articles')
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('article') and code = 'unselect_child_articles')
    INSERT INTO BACKEND_ACTION (TYPE_ID, ENTITY_TYPE_ID, NAME, SHORT_NAME, CODE, IS_INTERFACE)
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'list_plugin')
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'new_plugin')
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'edit_plugin')
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'update_plugin')
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'refresh_plugin')
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'remove_plugin')
...
if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'save_plugin')
    insert into BACKEND_ACTION(NAME, CODE, TYPE_ID, ENTITY_TYPE_ID, IS_INTERFACE)
    values('Save QP Plugin', 'save_plugin', dbo.qp_action_type_id('save'), dbo.qp_entity_type_id('plugin'), 0)

if not exists (select * From BACKEND_ACTION where ENTITY_TYPE_ID = dbo.qp_entity_type_id('plugin') and code = 'refresh_plugins')
    insert into BACKEND_ACTION(NAME, CODE, TYPE_ID, ENTITY_TYPE_ID, IS_INTERFACE)
