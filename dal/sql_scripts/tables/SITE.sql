...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SITE' AND COLUMN_NAME = 'USE_NATIVE_EF_TYPES')
BEGIN
    ALTER TABLE SITE ADD USE_NATIVE_EF_TYPES [bit] NOT NULL DEFAULT ((0))
END
GO
