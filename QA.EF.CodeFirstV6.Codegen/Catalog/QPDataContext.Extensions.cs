...
{
    public partial class QPDataContext: IQPLibraryService, IQPFormService
    {
		#region Constructors

		public QPDataContext(string connectionStringOrName)
		...
		public QPDataContext(DbConnection connection, bool contextOwnsConnection)
        ...
        public QPDataContext(DbCompiledModel model) : base(model)
        {
            this.Configuration.LazyLoadingEnabled = false;
            OnContextCreated();
        }

        public QPDataContext(DbConnection connection, DbCompiledModel model, bool contextOwnsConnection)
		...
		public static QPDataContext Create(IMappingConfigurator configurator, SqlConnection connection, bool contextOwnsConnection)
        {
            var ctx = new QPDataContext(connection, configurator.GetBuiltModel(connection), contextOwnsConnection);
		...
		public static QPDataContext Create(string connection, string siteName) 
		{
			...
			{
				ctx = new QPDataContext(new SqlConnection(connection), true);
				ctx.SiteName = siteName;
				ctx.ConnectionString = connection;
				return ctx;
			}

			ctx = new QPDataContext(connection);
			ctx.SiteName = siteName;
			ctx.ConnectionString = connection;
			return ctx;
		}

		public static QPDataContext Create(SqlConnection connection, string siteName) 
		{
			QPDataContext ctx = new QPDataContext(connection, false);
			ctx.SiteName = siteName;
			ctx.ConnectionString = connection.ConnectionString;
			return ctx;
		}
