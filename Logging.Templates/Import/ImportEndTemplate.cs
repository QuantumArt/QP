...
namespace Quantumart.QP8.Logging.Templates.Import
{
    ...
    #line 1 "C:\Source\QP8\Main\Logging.Templates\Import\ImportEndTemplate.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 9 "C:\Source\QP8\Main\Logging.Templates\Import\ImportEndTemplate.tt"
            ...
            #line 10 "C:\Source\QP8\Main\Logging.Templates\Import\ImportEndTemplate.tt"
            ...
            #line 11 "C:\Source\QP8\Main\Logging.Templates\Import\ImportEndTemplate.tt"
            ...
            #line 12 "C:\Source\QP8\Main\Logging.Templates\Import\ImportEndTemplate.tt"
            ...
            #line 13 "C:\Source\QP8\Main\Logging.Templates\Import\ImportEndTemplate.tt"
            ...
            #line 14 "C:\Source\QP8\Main\Logging.Templates\Import\ImportEndTemplate.tt"
...
{
    if ((typeof(global::Quantumart.QP8.BLL.Services.MultistepActions.Import.ImportSettings).IsAssignableFrom(this.Session["Model"].GetType()) == false))
    {
        this.Error("The type \'Quantumart.QP8.BLL.Services.MultistepActions.Import.ImportSettings\' of " +
...
if ((ModelValueAcquired == false))
{
    ...
    if ((data != null))
    {
        if ((typeof(global::Quantumart.QP8.BLL.Services.MultistepActions.Import.ImportSettings).IsAssignableFrom(data.GetType()) == false))
        {
            this.Error("The type \'Quantumart.QP8.BLL.Services.MultistepActions.Import.ImportSettings\' of " +
                    "the parameter \'Model\' did not match the type of the data passed to the template." +
                    "");
