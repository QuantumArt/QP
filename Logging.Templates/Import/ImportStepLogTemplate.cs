...
namespace Quantumart.QP8.Logging.Templates.Import
{
    ...
    #line 1 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "11.0.0.0")]
    public partial class ImportStepLogTemplate : ImportStepLogTemplateBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 9 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
            ...
            #line 10 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.Settings.Id));
            
            #line default
            #line hidden
            this.Write("\r\n    ImportAction: ");
            
            #line 11 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
            ...
            #line 12 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.Step));
            
            #line default
            #line hidden
            this.Write("\r\n    Inserted: ");
            
            #line 13 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.Settings.InsertedArticleIds.Count));
            
            #line default
            #line hidden
            this.Write("\r\n    Updated: ");
            
            #line 14 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.Settings.UpdatedArticleIds.Count));
            
            #line default
            #line hidden
            this.Write("\r\n");
            
            #line 15 "C:\Source\QP8\Main\Logging.Templates\Import\ImportStepLogTemplate.tt"
...
{
    if ((typeof(global::Quantumart.QP8.Logging.Loggers.ImportStepSettings).IsAssignableFrom(this.Session["Model"].GetType()) == false))
    {
        this.Error("The type \'Quantumart.QP8.Logging.Loggers.ImportStepSettings\' of the parameter \'Mo" +
                "del\' did not match the type of the data passed to the template.");
    }
    else
    {
...
if ((ModelValueAcquired == false))
{
    ...
    if ((data != null))
    {
        if ((typeof(global::Quantumart.QP8.Logging.Loggers.ImportStepSettings).IsAssignableFrom(data.GetType()) == false))
        {
            this.Error("The type \'Quantumart.QP8.Logging.Loggers.ImportStepSettings\' of the parameter \'Mo" +
                    "del\' did not match the type of the data passed to the template.");
        }
...
{
    if ((typeof(global::Quantumart.QP8.Logging.Loggers.LoggerContext).IsAssignableFrom(this.Session["Context"].GetType()) == false))
    {
        this.Error("The type \'Quantumart.QP8.Logging.Loggers.LoggerContext\' of the parameter \'Context" +
...
if ((ContextValueAcquired == false))
{
    ...
    if ((data != null))
    {
        if ((typeof(global::Quantumart.QP8.Logging.Loggers.LoggerContext).IsAssignableFrom(data.GetType()) == false))
        {
            this.Error("The type \'Quantumart.QP8.Logging.Loggers.LoggerContext\' of the parameter \'Context" +
                    "\' did not match the type of the data passed to the template.");
        }
...
{
    if ((typeof(global::Microsoft.Practices.EnterpriseLibrary.Logging.LogEntry).IsAssignableFrom(this.Session["LogEntry"].GetType()) == false))
    {
        this.Error("The type \'Microsoft.Practices.EnterpriseLibrary.Logging.LogEntry\' of the paramete" +
                "r \'LogEntry\' did not match the type of the data passed to the template.");
    }
    else
    {
...
if ((LogEntryValueAcquired == false))
{
    ...
    if ((data != null))
    {
        if ((typeof(global::Microsoft.Practices.EnterpriseLibrary.Logging.LogEntry).IsAssignableFrom(data.GetType()) == false))
        {
            this.Error("The type \'Microsoft.Practices.EnterpriseLibrary.Logging.LogEntry\' of the paramete" +
                    "r \'LogEntry\' did not match the type of the data passed to the template.");
        }
...
{
    if ((typeof(global::System.Diagnostics.TraceOptions).IsAssignableFrom(this.Session["TraceOptions"].GetType()) == false))
    {
        this.Error("The type \'System.Diagnostics.TraceOptions\' of the parameter \'TraceOptions\' did no" +
...
if ((TraceOptionsValueAcquired == false))
{
    ...
    if ((data != null))
    {
        if ((typeof(global::System.Diagnostics.TraceOptions).IsAssignableFrom(data.GetType()) == false))
        {
            this.Error("The type \'System.Diagnostics.TraceOptions\' of the parameter \'TraceOptions\' did no" +
                    "t match the type of the data passed to the template.");
        }
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "11.0.0.0")]
    public class ImportStepLogTemplateBase
    {
        #region Fields
