    ...
    public class SiteController : QPController
    {
        ...
        public ActionResult New(string tabId, int parentId, FormCollection collection)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return Redirect("Properties", new { tabId = tabId, parentId = parentId, id = model.Data.Id, successfulActionCode = ActionCode.SaveSite });
            }
            else
                return JsonHtml("Properties", model);
        }
        ...
        public ActionResult Properties(string tabId, int parentId, int id, FormCollection collection)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return Redirect("Properties", new { tabId = tabId, parentId = parentId, id = model.Data.Id, successfulActionCode = ActionCode.UpdateSite });
            }
            else
                return JsonHtml("Properties", model);
        }
