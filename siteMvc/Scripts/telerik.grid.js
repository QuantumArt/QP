(function ($, undefined) {
    ...
    $t.grid.prototype = {
        ...
        _isRightScrollBar: function() {
            var Chrome19 = 536; // 536.5 precisely
            return ($.browser.webkit && parseInt($.browser.version, 10) < Chrome19) || ($.browser.mozilla && parseInt($.browser.version, 10) < 2);
        },
                    ...
                    return $.map(column.filters, function(filter) {                        
                        ...
                        if (filters) {
                            for (idx = 0, length = filters.length; idx < length; idx++) {                           
                                ...
                                filters[idx].field = column.member;
                            }
                        }
        ...
        showColumn: function(column) {
            ...
            if (!column.width) {
                ...
                for(idx= 0, length = cols.length; idx < length; idx++) { 
                    if (cols[idx].style.width.indexOf("%") > -1) {
                        tableWidth = 0;
                        break;
                    }                                         
