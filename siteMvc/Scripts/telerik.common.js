    ...
    $t.dropDown.prototype = {
        ...
        open: function (position) {
            ...
            if ($element[0].style.width == '') {
                ...
                width = parseInt(this.attr ? $('<div' + this.attr + '></div>')[0].style.width : ($.browser.msie && $.browser.version > 8 ? $element.outerWidth() : $element[0].style.width));
            }
