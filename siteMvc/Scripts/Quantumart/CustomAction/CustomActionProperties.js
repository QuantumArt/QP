...
export class CustomActionEntityTypesObserver {
  constructor(entityTypesElementId, actionsElementId, contentsElementId) {
    ...
    const setFilter = function () {
      ...
      if (id) {
        const code = BackendEntityType.getEntityTypeById(id).Code;
        const testCodes = [
    ...
    const updateActionList = function (selectedActions) {
      ...
      const dictionary = BackendEntityType.getEntityTypeIdToActionListItemDictionary();
...
export class CustomActionIsInterfaceSelectorObserver {
  constructor(
...
Quantumart.QP8.CustomActionEntityTypesObserver = CustomActionEntityTypesObserver;
Quantumart.QP8.CustomActionIsInterfaceSelectorObserver = CustomActionIsInterfaceSelectorObserver;
