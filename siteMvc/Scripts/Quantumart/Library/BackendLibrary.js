...
Quantumart.QP8.BackendLibrary.prototype = {
	...
	set_libraryManager: function (value) { this._libraryManager = value; },
	get_libraryManager: function () { return this._libraryManager; },
	set_folderId: function (value) { this._folderId = value; },
	get_folderId: function () { return this._folderId; },
	set_viewTypeCode: function (value) { this._viewTypeCode = value; },
	get_viewTypeCode: function () { return this._viewTypeCode; },
	...
	_onSplitterResized: function (eventType, sender, eventArgs) {
		this.notify(EVENT_TYPE_LIBRARY_RESIZED, {});
		this._splitter.resize();
	},
