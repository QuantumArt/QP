...
export class BackendFileNameListView extends Observable {
      ...
      $.each(data.Data, (index, item) => {
        html
          ...
          .cat(String.format('<img src="{1}{2}" /><label>{0}</label></div></li>',
            ...
            window.THEME_IMAGE_FOLDER_URL_SMALL_FILE_TYPE_ICONS,
            item.SmallIconLink));
...
Quantumart.QP8.BackendFileNameListView = BackendFileNameListView;
