window.Backend.Lang.EntityEditor = {
  ...
  autoRefreshConfirmMessage:
  'Exist opened form for editing that have become irrelevant.'
  + '\nYou want to update this form with the loss of all changes?',
  autoRefreshConfirmMessageAfterArticleRestoring:
  'Exist opened form for editing article (id = {0}), properties of which became irrelevant after restoring version.'
  + '\nYou want to update this form with the loss of all changes?',
  variationExists: 'There is existing variation for the selected context',
  newVariationExists:
  'There is new (unsaved) variation for the selected context that will be saved along with base article',
