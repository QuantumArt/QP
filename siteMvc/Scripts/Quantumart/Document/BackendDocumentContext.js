...
Quantumart.QP8.BackendDocumentContext.prototype = {
  test: function() {
	...
	get_mainComponent: function () { return this._mainComponent; },
	get_mainComponentType: function () { return this._mainComponentType; },
	get_state: function () { return this._state; },

	set_initializingCallback: function (value) { this._initializingCallback = value; },
	set_initializedCallback: function (value) { this._initializedCallback = value; },
	set_terminatingCallback: function (value) { this._terminatingCallback = value; },
	set_terminatedCallback: function (value) { this._terminatedCallback = value; },
	set_execSelectCallback: function (value) { this._execSelectCallback = value; },
	set_hostLoadedCallback: function (value) { this._hostLoadedCallback = value; },
	...
	createMainComponent: function (host) {
		...
		if (this._mainComponentType == $e.MainComponentType.Grid) {
			mainComponent = Quantumart.QP8.BackendEntityGridManager.getInstance().createGrid(
			...
			mainComponent = Quantumart.QP8.BackendEntityTreeManager.getInstance().createTree(
				this._mainComponentId, this._entityTypeCode, this._parentEntityId, this._actionCode, this._options, hostOptions
			);
			...
			mainComponent = Quantumart.QP8.BackendLibraryManager.getInstance().createLibrary(
