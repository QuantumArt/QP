...
Quantumart.QP8.BackendDocumentHost.prototype = {
	...
	get_documentWrapperElementId: function () { return this._documentWrapperElementId; },
	get_documentWrapperElement: function () { return this._documentWrapperElement; },
	get_documentUrl: function () { return this._documentUrl; },
	get_selectedEntities: function () { return this._selectedEntities; },
	get_filter: function () { return this._filter; },

	get_hostType: $c.notImplemented,
	get_zIndex: $c.notImplemented,

	get_documentContext: function () { return this._documentContext; },
	set_documentContext: function (value) {
		this._documentContext = value;
	},

	get_entityTypeCode: function () { return this._entityTypeCode; },
	set_entityTypeCode: function (value) { this._entityTypeCode = value; },
	...
	get_isCustomAction: function () { return this._isCustomAction; },
	set_isCustomAction: function (value) { this._isCustomAction = value; },
	...
	get_actionTypeCode: function () { return this._actionTypeCode; },
	set_actionTypeCode: function (value) { this._actionTypeCode = value; },
		...
		if ($q.isNullOrEmpty(this.loadHostState())) {
			...
			if (!$q.isNullOrEmpty(filterStates) && $q.isArray(filterStates)) {
				...
				var searchQuery = jQuery.map(filterStates, function (item) {
					var ids = jQuery.map(item.SelectedEntities, function (ent) { return ent.Id; });
	...
	executeAction: function (actionCode) {
		...
		if (action == null) {
			...
			if (isMultiple)
			{
			    ...
			    var unnamedEntities = jQuery.grep(entities, function (elem) { return !elem.Name; });
			    ...
			    if (unnamedEntities.length > 0 && unnamedEntities.length <= this._unnamedEntitiesLimit)
			    {
			        ...
			        var namedEntities = jQuery.map(dataItems, function (item) { return { Id: $q.toInt(item.Value), Name: item.Text }; });
  ...
  onSearch: function (eventType, sender, args) {
	...
	onEntitySubmitting: function (eventArgs) {
		this.onDocumentChanging();
	},
	...
	onEntitySubmittedError: function (eventArgs) {
	...
	onDataBinding: function (eventArgs) {
	...
	onSearchViewToolbarButtonClicked: function (eventType, sender, eventArgs) {
	...
	onContextViewToolbarButtonClicked: function (eventType, sender, eventArgs) {
