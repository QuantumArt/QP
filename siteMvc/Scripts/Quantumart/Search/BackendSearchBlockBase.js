...
export class BackendSearchBlockBase extends Observable {
  constructor(
  ...
  _onSearchBlockResized() {
    ...
    const eventArgs = new BackendSearchBlockEventArgs(0, '');
...
BackendSearchBlockBase.generateElementPrefix = function () {
  return `q${$q.generateRandomString(6)}`;
};

export class BackendSearchBlockEventArgs extends Sys.EventArgs {
  constructor(searchBlockType, searchQuery) {
    super();
...
Quantumart.QP8.BackendSearchBlockBase = BackendSearchBlockBase;
Quantumart.QP8.BackendSearchBlockEventArgs = BackendSearchBlockEventArgs;
