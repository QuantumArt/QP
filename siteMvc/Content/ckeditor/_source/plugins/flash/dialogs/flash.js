...
(function () {
	...
	*/
	...
	function onPopupClickHandler() {
	    ...
	    var popup = isContentLibrary === true ? $field.data("flashWindow-content") : $field.data("flashWindow-site");
	    if (!popup) {
	        ...
	        var options = {
	            "additionalUrlParameters": { "filterFileTypeId": Quantumart.QP8.Enums.LibraryFileType.Flash, "subFolder": "" },
	            "zIndex": currentZIndex + 10,
	            "libraryUrl": $field.data('library_url')
	        };
	        popup = new Quantumart.QP8.LibraryPopupWindow(eventArgs, options);
	        isContentLibrary === true ? $field.data("flashWindow-content", popup) : $field.data("flashWindow-site", popup);
	    }
	    popup.setContentId(0);
	    if (isContentLibrary === true) {
	        popup.setContentId($field.data('content_id'));
	    }
	    popup.setSelectCallback(function (url) {
								...
								},
                                 {
                                     ...
                                     [

										{
										    ...
										    onClick:
										        jQuery.proxy(onPopupClickHandler, false)                                               
										},
                                        {
                                            type: 'button',
                                            id: 'browseContent',
