...
CKEDITOR.dialog.add('link', function (editor) {
	...
	function onPopupClickHandler() {
	    ...
	    if (dialog) {
	        ...
	        var popup = isContentLibrary === true ? $field.data("linkWindow-content") : $field.data("linkWindow-site");
	        if (!popup) {
	            var eventArgs = new Quantumart.QP8.BackendEventArgs();
	            eventArgs.set_entityId(isContentLibrary === true ? $q.toInt($field.data("content_id")) : $q.toInt($field.data("library_entity_id"), 0));
					...
					},
					{
						...
						[
							...
							},
                            {
                                ...
                                //								hidden : 'true',
                                //								filebrowser : 'info:url',
                                label: commonLang.browseContentLibrary,
