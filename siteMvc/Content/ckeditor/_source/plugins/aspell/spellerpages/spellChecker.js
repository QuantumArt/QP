...
window.spellChecker = function( textObject ) {
	...
	this.popUpProps = "menu=no,width=440,height=350,top=70,left=120,resizable=no,status=no";	// by FredCK
    this.spellCheckScript = '/Backend/VisualEditorConfig/AspellCheck'; //'/speller/server-scripts/spellchecker.php';//
...
window.spellChecker.prototype = {

    // call this method to check all text boxes (and only text boxes) in the HTML document
    checkTextBoxes: function () {
    ...
    startCheck: function ( wordWindowObj, controlWindowObj ) {
