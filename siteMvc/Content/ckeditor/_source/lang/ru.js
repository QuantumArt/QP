...
CKEDITOR.lang['ru'] =
{
	...
	linebreak: 'Вставить новую строку',
	...
	common :
	{
	    browseContentLibrary: 'Просмотр библиотеки контента',	    
	    browseServer    : 'Просмотр библиотеки сайта',
		url				: 'URL',
		protocol		: 'Протокол',
		upload			: 'Закачать',
	...
	cleaner:
	{
		buttonLabel: "Чистка HTML",
		wordClearCheckbox: "Разметка Microsoft Word",
		cssClearCheckbox: "Атрибуты CSS",
		spanClearCheckbox: "Теги SPAN",
		fontClearCheckbox: "Теги FONT",
		tableClearCheckbox: "Фиксированная ширина в таблицах/строках/ячейках",
		tagsClearCheckbox: "Все HTML-теги"
	},
