...
namespace QP8.Integration.Tests
{
    ...
    public class ContentGroupFixture
    {
        ...
        public void ReplayXML_CreateContentGroup_WithSpecifiedIdentity()
        {
            ...
            var service = new XmlDbUpdateNonMvcReplayService(Global.ConnectionString, new HashSet<string>(new[] { EntityTypeCode.ContentGroup }), 1, false, dbLogService.Object, new ApplicationInfoRepository(), new XmlDbUpdateActionCorrecterService(new ArticleService(new ArticleRepository())), new XmlDbUpdateHttpContextProcessor(), false);
