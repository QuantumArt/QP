...
namespace QP8.WebMvc.NUnit.Tests.BLL.Repository.Articles
{
    ...
    public class ArticleFilterSearchQueryParserTest
    {
        ...
        /// </summary>
        /// <returns></returns>
        private static IEnumerable<FilterParserTestData> CreateCommonFilterParseTestData()
        {
            return new[]
            {
        ...
        /// Параметры тестов метода ArticleSearchQueryParser.GetFilter
        /// </summary>
        private static IEnumerable<FilterParserTestData> CreateAllFilterSearchTypeTestData()
        {
            return new[]
            {
                #region All type
        ...
        /// Параметры тестов метода ArticleSearchQueryParser.GetFilter
        /// </summary>
        private static IEnumerable<FilterParserTestData> CreateTextSearchTestData()
        {
            return new[]
            {
                #region Text
        ...
        /// Параметры тестов метода ArticleSearchQueryParser.GetFilter
        /// </summary>
        private static IEnumerable<FilterParserTestData> CreateDateRangeTestData()
        {
            return new[]
            {
                #region DateRange
        ...
        /// Параметры тестов метода ArticleSearchQueryParser.GetFilter
        /// </summary>
        private static IEnumerable<FilterParserTestData> CreateTimeRangeTestData()
        {
            return new[]
            {
                #region TimeRange
        ...
        /// Параметры тестов метода ArticleSearchQueryParser.GetFilter
        /// </summary>
        private static IEnumerable<FilterParserTestData> CreateNumericRangeTestData()
        {
            return new[]
            {
                #region NumericRange
        ...
        /// Параметры тестов метода ArticleSearchQueryParser.GetFilter
        /// </summary>
        private static IEnumerable<FilterParserTestData> CreateBooleanTestData()
        {
            return new[]
            {
                #region Boolean
        ...
        /// Параметры тестов метода ArticleSearchQueryParser.GetFilter
        /// </summary>
        private static IEnumerable<FilterParserTestData> CreateO2MRelationTestData()
        {
            return new[]
            {
                #region O2MRelation
            ...
            foreach (var testData in testDataCollection)
            {
                ...
                catch (Exception exp)
                {
                    if (testData.ExpectedExceptionType == null)
                    {
                        ...
                        Assert.Fail($"\"{testData.Description}\" test is failed. Unexpected exception: {exp.GetType()}.");
                    }
                    Assert.IsInstanceOfType(exp, testData.ExpectedExceptionType, $"\"{testData.Description}\" test is failed. Unexpected exception: {exp.GetType()}.");
                }
            }
