...
namespace Quantumart.QPublishing.Controls
{
    ...
    {
        IQPage QPage { get; set; }

        bool DisableDataBind { get; set; }

        bool UseSimpleInitOrder { get; set; }

        DateTime TraceStartTime { get; set; }

        string TraceObjectString { get; set; }

        string TraceString { get; set; }

        string UndefTraceString { get; set; }

        string TraceStartText { get; set; }

        Hashtable QpDefValues { get; set; }
        ...
        string absolute_site_url { get; }

        int page_id { get; }

        string upload_url { get; }

        bool AbsUploadURL { get; }

        string UploadURLPrefix { get; }
        ...
        int published_status_type_id { get; }

        string published_status_name { get; }
