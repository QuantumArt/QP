...
namespace Quantumart.QPublishing.Pages
{
    ...
    {
        QPageEssential QPageEssential {
            get;
            set;
        }
        bool UseMultiSiteLogic {
            get;
            set;
        }
        bool IsLocalAssembling {
            get;
            set;
        }
        QScreen QScreen {
        ...
        string Controls_Folder {
            get;
            set;
        }
        string ControlsFolderName {
            get;
        }
        string TemplateNetName {
            get;
            set;
        }
        string TemplateName {
        ...
        HttpCacheRevalidation HttpCacheRevalidation {
            get;
            set;
        }
        ...
        byte includeArchive);
        DataTable GetContentDataWithSecurity(string siteName, string contentName, string whereExpression, string orderExpression, long startRow, long pageSize, ref long totalRecords, byte useSchedule, string statusName, byte showSplittedArticle,
