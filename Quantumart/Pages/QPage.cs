...
namespace Quantumart.QPublishing.Pages
{
    ...
    public class QPage : Page, IQPage
    {
        ...
        {
            AddHeader("last-modified", dt.ToString("r"));
        }
        
        public void AddLastModfiedHeader()
        {
            AddLastModifiedHeader(LastModified);
        }
        void IQPage.AddLastModifiedHeader()
        {
        ...
        {
            ShowControl(name, sender, null);
        }
        
        public void ShowControl(string name)
        {
            ShowControl(name, this, null);
        }
        ...
        //Public Overridable Sub ControlInit(ByVal sender As System.Object, ByVal e As System.EventArgs) Implements IQPage.ControlInit
        //superPage.ControlInit(sender, e)
        //End Sub
        ...
        public virtual string upload_url {
        ...
        public virtual string GetInternalCall(string userCall)
        {
