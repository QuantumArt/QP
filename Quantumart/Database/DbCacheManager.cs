...
namespace Quantumart.QPublishing.Database
{
    public class DbCacheManager
    {
        ...
        private string GetAttributeQuery()
        {
            ...
            sb.Append(" CA.INPUT_MASK, CA.ATTRIBUTE_SIZE, CASE WHEN ca.attribute_type_id in (9, 10) THEN convert(nvarchar(max), ca.DEFAULT_BLOB_VALUE) ELSE ca.DEFAULT_VALUE END as DEFAULT_VALUE, ");
            ...
            sb.Append(" CL.LINKED_CONTENT_ID, COALESCE(RA.CONTENT_ID, CL.LINKED_CONTENT_ID, RCA.CONTENT_ID) AS RELATED_CONTENT_ID, CCR.CONSTRAINT+ID");
